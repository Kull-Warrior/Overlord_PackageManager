    ...
    public abstract class MapFactory
    {
        ...
        public static Entry CreateDataSubTableType21SubTableType20SubTableType34(BinaryReader reader, uint id, uint relOffset)
        {
            return id switch
            {
                ...
                23 => new UInt32CountedArrayEntry(id, relOffset),
                // Add more IDs here
                _ => new ByteArrayEntry(id, relOffset),   // Unknown entry
            };
        }
        ...
        public static Entry CreateInfoTable(BinaryReader reader, uint id, uint relOffset)
        {
            return id switch
            {
                ...
                36 => new UInt32Entry(id, relOffset),
        ...
        public static Entry CreateRootTable(BinaryReader reader, uint id, uint relOffset)
        {
            return id switch
            {
                ...
                51 => new UInt32Entry(id, relOffset),
                ...
                104 => new UInt32Entry(id, relOffset),
                106 => new ByteEntry(id, relOffset),
                108 => new ByteEntry(id, relOffset),
                110 => new UInt32Entry(id, relOffset),
                ...
                121 => new UInt32Entry(id, relOffset),
                122 => new LuaEntry(id, relOffset),
                123 => new LuaEntry(id, relOffset),
                124 => new TableEntry(id, relOffset),   // Unknown entry
                125 => new UInt32Entry(id, relOffset),
                126 => new UInt32Entry(id, relOffset),
                127 => new LuaEntry(id, relOffset),
                128 => new UInt32Entry(id, relOffset),
                129 => new UInt32Entry(id, relOffset),
