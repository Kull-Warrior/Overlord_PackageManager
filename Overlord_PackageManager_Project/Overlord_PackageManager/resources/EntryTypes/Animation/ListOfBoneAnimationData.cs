...
{
    class ListOfBoneAnimationData(uint id, uint relOffset) : Entry(id, relOffset), IHasRefTable
    {
        ...
        public override void Read(BinaryReader reader, long origin)
        {
            ...
            foreach (var entry in Table.Entries)
            {
                ...
                {
                    ((BoneAnimationData)entry).Read(reader, Table.origin, 0, BoneAnimationDataDictionary);
                }
            }
        }
    }
